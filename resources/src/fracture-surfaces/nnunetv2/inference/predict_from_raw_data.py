...
class nnUNetPredictor(object):
    ...
    def predict_from_files(self,
        ...
        return self.predict_from_data_iterator(data_iterator, save_probabilities, num_processes_segmentation_export, sum_logits=sum_logits)
    ...
    def predict_from_data_iterator(self,
        ...
        with multiprocessing.get_context("spawn").Pool(num_processes_segmentation_export) as export_pool:
            ...
            for preprocessed in data_iterator:
                ...
                prediction = self.predict_logits_from_preprocessed_data(data, sum_logits=sum_logits).cpu()
    ...
    def predict_single_npy_array(self, input_image: np.ndarray, image_properties: dict,
        ...
        import copy
        data_properties = copy.deepcopy(dct['data_properties'])
        free_memory(['ppa', 'dct'])
        self.network = None
        self.list_of_parameters = None
        del self.network
        del self.list_of_parameters
        gc.collect()
        torch.cuda.empty_cache()
        ...
        if output_file_truncated is not None:
            export_prediction_from_logits(predicted_logits, data_properties, self.configuration_manager,
    ...
    def predict_logits_from_preprocessed_data(self, data: torch.Tensor, sum_logits=False) -> torch.Tensor:
        """
    ...
    def _internal_predict_sliding_window_return_logits(self,
        ...
        try:
            ...
            data = data.to(results_device) #MARKER .to(device)
...
def predict_entry_point():
    ...
    parser.add_argument('--disable_progress_bar', action='store_true', required=False, default=False,
                        help='Set this flag to disable progress bar. Recommended for HPC environments (non interactive '
                             'jobs)')
    parser.add_argument('--sum_logits', action='store_true', required=False, default=False,
                        help='Set this flag to sum logits insted of taking mean.')
