...
def collect_cv_niftis(cv_folder: str, output_folder: str, validation_folder_name: str = 'validation_raw',
    ...
    for f in folds:
        niftis = subfiles(validation_raw_folders[f], suffix=".mha")
        for n in niftis:
...
def consolidate_folds(output_folder_base, validation_folder_name: str = 'validation_raw',
    ...
    num_niftis_gt = len(subfiles(join(output_folder_base, "gt_niftis"), suffix='.mha'))
    # count niftis in there
    num_niftis = len(subfiles(output_folder_raw, suffix='.mha'))
    ...
    niftis = subfiles(output_folder_raw, join=False, suffix=".mha")
